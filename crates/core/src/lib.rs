...
//!
//! The headless engine of notes-gpui. It currently holds the persisted window
//! geometry type (geometry::Rect) and the state-directory rule
//! (paths::resolve_state_dir); the document model, session serialisation and
//! the save engine land here in later milestones. No UI or OS types; failures
